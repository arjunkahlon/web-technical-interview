                    ...
                    <div className="relative max-w-full p-5 -mt-14 bg-white rounded-xl">
                        <div className="flex flex-row text-xl text-primary font-extrabold pl-3 z-40">
                            ...
                            <div className="flex flex-col basis-1/5">
                                <svg width="30" height="30" viewBox="0 0 24.00 24.00" fill="none" xmlns="http://www.w3.org/2000/svg" stroke="#000000" stroke-width="0.00024000000000000003" className="inline-block">
                        ...
                        <div className="flex justify-around text-sm">
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-bed inline-block" width="15" height="15" viewBox="0 0 24 24" stroke-width="1.5" stroke="#696BA4" fill="currentColor" stroke-linecap="round" stroke-linejoin="round">
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-calendar inline-block" width="15" height="15" viewBox="0 0 24 24" stroke-width="1.5" stroke="#696BA4" fill="currentColor" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-bath inline-block" width="16" height="16" viewBox="0 0 24 24" stroke-width="1.5" stroke="#696BA4" fill="currentColor" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
                            ...
                            <div>
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-home inline-block" width="15" height="15" viewBox="0 0 24 24" stroke-width="1.5" stroke="#696BA4" fill="currentColor" stroke-linecap="round" stroke-linejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" fill="none"/>
